...
class AStarPlanner(Node):
    ...
    def goal_callback(self,pose:PoseStamped):
        ...
        path = self.plan(map_to_base_pose, pose.pose) # map_to_base is current position(start) in map & pose.pose is goal(end)
