...
class OdometryMotionModel(Node):
    ...
    def __init__(self):
        ...
        if self.nr_samples >= 0:
            ...
            self.samples.poses = [Pose() for __ in range(self.nr_samples)]
        ...
        self.pose_array_pub_ = self.create_subscription(PoseArray, "odometry_motio_model/samples",10)
    ...
    def odomCallback(self,odom):
        ...
        delta_rot2 = angle_diff(odom_x_increment,delta_rot1)
