...
class SimpleTfKinematics(Node):
    def __init__(self):
        ...
        self.static_tf_braodcaster_ = StaticTransformBroadcaster(self)
        self.dynamic_tf_brodacster_ = TransformBroadcaster(self)
        ...
        self.static_tf_braodcaster_.sendTransform(self.static_transform_stamped_)
