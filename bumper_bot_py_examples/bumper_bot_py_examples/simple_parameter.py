...
class SimpleParameter(Node):
    def __init__(self):
        ...
        self.declare_parameter("simple_string_param","Adinath")
    ...
    def paramChangeCallback(self,params):
        ...
        for param in params:
            ...
            if Parameter.name == "simple_string_param" and param.type__ == Parameter.Type.STRING:
                self.get_logger().info("Param simple_string_param chnaged! New value is %d" %param.value)
