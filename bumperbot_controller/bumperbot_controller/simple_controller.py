...
class SimpleController(Node):
    def __init__(self):
        ...
        self.wheel_separation_ = self.get_parameter("wheel_seperation").get_parameter_value().double_value

        self.get_logger().info("Using wheel_radius" % self.wheel_radius_)
        self.get_logger().info("Using wheel_seperation" % self.wheel_separation_)
        ...
        #self.vel_sub = self.create_subscription(TwistStamped,"/cmd_vel",self.velCallback,10)
