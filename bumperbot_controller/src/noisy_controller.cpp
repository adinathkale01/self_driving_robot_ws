    ...
    ,theta_(0.0)
{
    ...
    RCLCPP_INFO_STREAM(get_logger(), "Using wheel_seperation " << wheel_separation_);
...
{   
    ...
    double angluar = (wheel_radius_ * fi_right - wheel_radius_ * fi_left) / wheel_separation_;
    ...
    odom_msg_.twist.twist.angular.z = angluar;
    ...
    RCLCPP_INFO_STREAM(get_logger(), "Linear: " << linear << "Angular: " << angluar);
